...
public class ArrayManager : MonoBehaviour
{
    ...
    [SerializeField] Transform swapPoint;
    ...
    void PosicionarElementosDelArray()
    {
        for (int i = 0; i < objectsCollection.Length; i++)
        {
            objectsCollection[i].transform.position = new Vector3(3.18f + i, 0.7f, -5.91f);
        }
    ...
    {
        Instantiate(objectsCollection[Random.Range(0,objectsCollection.Length)], swapPoint.position,Quaternion.identity);
    }
}
